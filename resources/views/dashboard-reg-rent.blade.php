...
<aside id="sidebar" class="transition-width w-64 h-max fixed top-16 bottom-16 lg:relative p-2">
  <div class="bg-white rounded p-2">
    <nav class="space-y-2 bg-white rounded p-2">
      ...
      <a href="{{ route('dashboard-reg-rent') }}" class="flex items-center space-x-2 text-white bg-gradient-to-r from-blue-500 to-purple-500 p-2 rounded">
      ...
      <tbody class="bg-white divide-y divide-gray-200">
        <tr class="hover:bg-gray-50 text-center">
          ...
          <td class="px-4 py-2 border">
            <span class="inline-block px-2 py-1 text-white rounded bg-green-500">Paid</span>
          </td>
          <td class="px-4 py-2 border">
            <span class="inline-block px-2 py-1 text-white rounded bg-yellow-500">Waiting</span>
          </td>
        </tr>

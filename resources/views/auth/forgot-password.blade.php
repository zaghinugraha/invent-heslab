...
<body class="flex items-center justify-center min-h-screen bg-cover bg-center background">
  ...
  <div class="awe rounded-lg shadow-lg p-8 w-full max-w-sm mx-auto">
    ...
    <div class="flex flex-col items-center">
      ...
      <h1 class="text-2xl font-bold gradient-text mb-6">Forgot Password</h1>
    </div>
    ...
    <form method="POST" action="{{ route('password.email') }}">
      ...
      <!-- Submit Button -->
      <button type="submit" class="w-full px-4 py-2 gradient-bg text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50">Email Password Reset Link</button>
    </form>
  </div>
